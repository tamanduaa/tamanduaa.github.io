$(document).ready(function() {
  var setting = ['space', 'wasteland', 'arrakis', 'prehistoric', 'megastructure', 'deep-water', 'jiang hu','misty mountains', 'underworld','hoth','labyrinth','medieval','crystal kingdom', 'moon', 'gondor', 'forest','mountain','tundra','asteroid','spaceship'];
